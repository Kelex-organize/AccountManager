    ...
    datasets: [
        {
            label: 'Gastos',
            data: [320, 180, 90, 120],
            backgroundColor: ['#f59e42', '#38bdf8', '#a78bfa', '#f87171'],
        },
    ],
}
const pieOptions = {
...
<template>
    <div class="p-6 bg-gray-900 text-gray-200">
        <h1 class="text-3xl font-bold mb-8 text-purple-400">Análisis de cuentas y gastos</h1>

        <!-- Gráfico de evolución de saldo de cuenta principal -->
        <div class="mb-10 p-4 rounded-2xl bg-gray-800 shadow-lg">
            <h2 class="text-xl font-semibold mb-4 text-cyan-400">
                Evolución de saldo (Cuenta Principal)
            </h2>
            <LineChart :data="balanceData" :options="balanceOptions" class="rounded-xl" />
        </div>
        ...
        <div class="mb-10 p-4 rounded-2xl bg-gray-800 shadow-lg">
            ...
            <PieChart :data="expenseTypeData" :options="pieOptions" class="rounded-xl" />
        </div>
    </div>
</template>
